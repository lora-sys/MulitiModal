...
class HeartRateFeatureExtractor:
    ...
    def extract(self, hr_signal):
        ...
        return {
            ...
            'hrv': np.std(np.diff(hr_signal)),  # 心率变异性
...
def main():
    ...
    print("=" * 60)
    print("\n输出文件:")
    print("  - data/aligned_data.csv: 对齐后的信号数据")
    print("  - features/fused_features.csv: 融合特征矩阵")
    print("  - results/test_results.csv: 测试结果")
    print("  - results/visualization.png: 可视化报告")
