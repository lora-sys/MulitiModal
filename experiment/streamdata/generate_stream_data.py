...
def generate_normal():
    ...
    p2 = (p_offset * 0.9) + amplitudes * np.sin(2 * np.pi * 0.5 * t + 0.1) + dynamic_noise2
...
def generate_pain():
    ...
    p2 = (p_offset * 0.9) + amps_smooth * np.sin(2 * np.pi * 0.5 * t + 0.1) + dynamic_noise2
